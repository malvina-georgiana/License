...
//	if ($sql_type_studii == 0){
		$sql = "INSERT INTO istoric_grad_didactic (cadru_didactic_fk, an_universitar_fk, grad_didactic_fk, categorie_fk, specializare_fk, domeniu_fk)
				VALUES  ('".$cadru_didactic_id."', '".$an_universitar."', '".$grad."', '".$categorie."', '".$specializare."', '".$domeniu."')";
//		echo $sql;
	//	exit;
//	}
	//update
